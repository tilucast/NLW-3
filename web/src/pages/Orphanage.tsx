  ...
  return (
    ...
    <div id="page-orphanage">
      ...
      <main>
        ...
        {orphanage.images[0] && <img src={orphanage.images[activeImageIndex].url} alt={orphanage.name} />}

          <div className="images">
            {orphanage.images && orphanage.images.map(({id, url}, index) => {
              return (
                <button 
                  key={id} 
                ...
                >
                  <img src={url} alt="Lar das meninas" />
                </button>
              )
            })}
          </div>
